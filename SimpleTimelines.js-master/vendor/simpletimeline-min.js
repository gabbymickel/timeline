...
var Timeline = (function () {
    function i(e, t) {
        _classCallCheck(this, i), (this.data = t), (this.wrapperId = e), (this.wrapper = document.getElementById(e)), (this.slidesWidth = 0), (this.docWidth = window.innerWidth), (this.timelineInner = null), (this.nodes = null);
    }
    return (
        _createClass(i, [
            {
            ...
            },
            {
                ...
                value: function (e) {
                    if (this.checkScreenSize()) {
                        var t = (100 * e.pageX) / this.docWidth,
                            i = (t / 100) * this.slidesWidth - (t / 200) * this.docWidth;
                ...
                value: function () {
                    ...
                    for (var s = 0; s < this.data.length; s++) {
                        ...
                        a.classList.add("tl-node"),
                            (a.innerHTML = '\n        <p class="above-year">'
                                .concat(this.data[s].year, '</p>\n        <div class="dot"></div>\n        <div class="data left-triangle" style="left: -20px; right: auto;">\n          <div class="upper">\n            <h5>')

                                .concat(this.data[s].year, "</h5>\n            <h3>")

                                .concat(this.data[s].title, "</h3>\n            <h6>")

                                .concat(this.data[s].body, '</h6>\n          </div>\n          <img src="')
